    ...
    private void createAction() {
        create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ShowAllProducts.this,Create.class);
                    ...
                    if (dataSnapshot.exists()) {
                        for (DataSnapshot data : dataSnapshot.getChildren()) {
                            if (data.exists()) {
                                ...
                                Log.i("hhhhhhhh",(String) map.get("name"));

                                Log.i("hhhhhhhh",(String) map.get("size"));

                                Log.i("hhhhhhhh",(String) map.get("colors"));

                                Log.i("hhhhhhhh",(String) map.get("price"));

                                Log.i("hhhhhhhh",(String) map.get("phone"));

                                Log.i("hhhhhhhh",(String) map.get("id"));

                                Log.i("hhhhhhhh",(String) map.get("image"));
                            }
                        }
                        updateRecyclerView();
                    }
    ...
    private void updateRecyclerView() {
        ...
        products.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent intent = new Intent(ShowAllProducts.this,Edit.class);
                intent.putExtra("sec",sec);
                intent.putExtra("data",data);
                intent.putExtra("section",section);
                intent.putExtra("type",type);
